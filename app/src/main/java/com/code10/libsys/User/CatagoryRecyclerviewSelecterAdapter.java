...
public class CatagoryRecyclerviewSelecterAdapter extends RecyclerView.Adapter<CatagoryRecyclerviewSelecterAdapter.ViewHolder> {
    ...
    Util.updateRecyclerView updateRecyclerView;
    private int selectedItem;

    public CatagoryRecyclerviewSelecterAdapter(Util.updateRecyclerView updateRecyclerView, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (selectedItem == position) {
            holder.cardCV.setCardBackgroundColor(context.getResources().getColor(R.color.purple_200));
        }
